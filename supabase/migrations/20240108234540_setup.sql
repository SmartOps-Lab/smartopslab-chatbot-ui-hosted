...
AS $$
DECLARE
  project_url TEXT := 'https://fggqmazawwbqmaqwceed.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZnZ3FtYXphd3dicW1hcXdjZWVkIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1Mzg5OTQzOCwiZXhwIjoyMDY5NDc1NDM4fQ.HD3_XCg9dIq2WR-jcxoWcylWmaAF5KWJwn6NLoZFqZ4'; -- full access needed for http request to storage
